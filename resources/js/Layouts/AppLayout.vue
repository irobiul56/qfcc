        ...
        <div class="flex justify-between items-center h-16 md:h-20">
          ...
          <Link :href="route('home')" class="flex-shrink-0">
            <img class="h-20 w-auto" 
                 src="/storage/images/qfcc-logo.png" 
          ...
          <nav class="hidden lg:block ml-10">
            <ul class="flex space-x-6 text-gray-700 font-medium">
              ...
              <li>
                <Link :href="route('programs')" class="hover:text-blue-600 transition-colors py-2 px-3 rounded-lg" :class="{ 'text-blue-600 border-b-2 border-blue-600': $page.url === '/programs-and-services' }">
                  PROGRAMS & SERVICES
                </Link>
              </li>
              <!-- <li>
              ...
              <li>
                <Link :href="route('get-involved')" class="hover:text-blue-600 transition-colors py-2 px-3 rounded-lg" :class="{ 'text-blue-600 border-b-2 border-blue-600': $page.url === '/get-involved' }">
                  GET INVOLVED
                </Link>
              </li>
          ...
          <div class="flex items-center space-x-2 sm:space-x-4">
            ...
            <!-- Donate Button -->
            <Link :href="route('donate')" class="px-3 py-1.5 text-sm font-semibold text-white bg-green-600 rounded-md shadow-lg hover:bg-red-700 transition duration-150 flex-shrink-0">
              Donation
            </Link>
